...
class DQNCritic(BaseCritic):
    ...
    def _build(self, q_func):
        ...
        self.q_t = tf.reduce_sum(self.q_t_values * tf.one_hot(self.act_t_ph, 256), axis=1)
        ...
        if self.double_q:
            ...
            best_action = tf.argmax(q_tp1_values, axis=1)
            print('best_action: ', best_action.get_shape())
            q_tp1 = tf.reduce_sum(q_tp1_values*best_action)
            print('q_tp1', q_tp1)
        else:
