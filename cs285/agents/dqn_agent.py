...
class DQNAgent(object):
    ...
    def step_env(self):
        ...
        """
        # DONE
        # T store the latest observation into the replay buffer
        # HINT: see replay buffer's function store_frame
        # self.last_obs always points to the last observation.
        self.replay_buffer_idx = self.replay_buffer.store_frame(self.last_obs)

        eps = self.exploration.value(self.t)
        # DONE
        # T use epsilon greedy exploration when selecting action
        ...
        if perform_random_action:
            ...
            # DONE:
            # T query the policy to select action
        ...
        # HINT3: store_effect(self, idx, action, reward, done)
