...
class PGAgent(BaseAgent):
    ...
    def train(self, obs, acs, rews_list, next_obs, terminals):
        ...
        # step 3:
        # DONE:
        # T: pass the calculated values above into the actor/policy's update,
    ...
    def calculate_q_vals(self, rews_list):
        ...
        if not self.reward_to_go:
            # DONE:
            # T: Estimate the Q value Q^{pi}(s_t, a_t) using rewards from that entire trajectory
        ...
        # Case 2: reward-to-go PG
            ...
            # DONE:
            # T: Estimate the Q value Q^{pi}(s_t, a_t) as the reward-to-go
    ...
    def estimate_advantage(self, obs, q_values):
        ...
        """
        # DONE:
        # T: Estimate the advantage when nn_baseline is True
    ...
    # DONE: T: implement this function
    ...
    def _discounted_cumsum(self, rewards):
        ...
        for start_time_index in range(len(rewards)):
            ...
            discounted_rtg = [self.gamma**(i - start_time_index) * rewards[i] for i in indices]
