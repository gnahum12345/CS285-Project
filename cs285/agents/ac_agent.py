...
class ACAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        # MLPPolicyAC.update(self, observations, acs_na, adv_n=None, acs_labels_na=None, qvals=None):
        #  BootstrappedContinuousCritic.update(self, ob_no, next_ob_no, re_n, terminal_n):
        critic_loss = -1
        actor_loss = -1
